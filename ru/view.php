...
<head>
    ...
    <link href="img/ico120.png" rel="apple-touch-icon">
    <link href="img/ico120.png" rel="apple-touch-icon" sizes="120x120">
    <link href="img/ico152.png" rel="apple-touch-icon" sizes="152x152">
    <meta charset="utf-8">
    ...
    <div>
        <div class="status-container mt-28">
            ...
            <div class="status-container-inner">
                <h4 id="main-title" class="title-h4 white status-title main-title">Сертификат COVID-19</h4>
                ...
                <h4 id="cert-id-block" class="title-h4 white status-title mt-12">
                    ...
                    <span class="unrz" id="cert-id"><?php echo $_REQUEST['num']; ?></span>
                </h4>
            </div>
        </div>
        <div id="dates-block" class="person-data person-data-dates mt-12">
            <div class="mb-4 person-data-wrap align-items-center">
                ...
                <div id="dates" class="small-text gray mr-4">Действует до <?php echo $_REQUEST['valid']; ?></div>
            </div>
        </div>
        <div class="person-data person-data-attrs mt-24">
            <div id="full-name-block" class="mb-4 person-data-wrap attr-wrap">
                <div id="full-name" class="attr-value title-h6 bold text-center"><?php echo $_REQUEST['name']; ?></div>
            </div>
            <div id="other-attrs">
                <div class="mb-4 person-data-wrap attr-wrap">
                    <div class="small-text mb-4 mr-4 attr-title">Дата рождения: </div>
                    <div class="attr-value small-text gray"><?php echo $_REQUEST['bdate']; ?></div>
                </div>
                <div class="mb-4 person-data-wrap attr-wrap">
                    <div class="small-text mb-4 mr-4 attr-title">Паспорт: </div>
                    <div class="attr-value small-text gray"><?php echo $_REQUEST['pasp']; ?></div>
                </div>
            </div>
        </div>
        <div class="mt-24"><a id="close" href="redirect.php" class="button">Закрыть</a>
        </div>
    </div>
